    ...
    >
      ...
      <div
        className={cn(
          ...
          "group-data-[side=left][collapsible=icon]:left-0 group-data-[side=right][collapsible=icon]:right-0",
          variant === "floating" || variant === "inset"
            ? "p-2 group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)_+_theme(spacing.4)_+2px)]"
            : "group-data-[collapsible=icon]:w-[--sidebar-width-icon] group-data-[side=left][collapsible=icon]:border-r group-data-[side=right][collapsible=icon]:border-l",
          className
        )}
        {...props}
      >
